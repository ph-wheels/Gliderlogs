...
public class ACRAPostSender implements ReportSender {
	private final static String BASE_URL = "http://www.your-acra-server.nl/acra_ezac.php?email=info@your-acra-server-email.nl";
	private final static String SHARED_SECRET = "GliderByEzac";
